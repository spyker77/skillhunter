...
def extract_text_from_resume(resume_in_memory):
...
def find_skills_in_resume(text_from_resume):
...
def find_suitable_vacancies(skills_in_resume):
...
def sort_suitable_vacancies(skills_in_resume, suitable_vacancies):
...
def analyze_resume(resume_in_memory):
